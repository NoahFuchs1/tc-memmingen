      ...
      <div className="container h-tag-wrapper my-10">
        ...
        <p>
          <span className="tsmcontroller">
            ...
            Deutschland
            <br />
            E-Mailadresse: info@tc-memmingen.de
            <br />
            Vertreten durch: Christian Vitek (1. Vorstand) und Marcel
            Seiz-Rosenhagen (2. Vorstand)
            <br />
            Link zum Impressum: https://tc-memmingen.de/index.php/impressum/
            <br />
          </span>
        </p>
        ...
        <p>
          ...
          verlässt und seinen Br/owser schließt. In einem solchen Cookie kann
          ...
          werden Cookies bezeichnet, die auch nach dem Schließen des Br/owsers
        ...
        <p>
          ...
          Systemeinstellungen ihres Br/owsers zu deaktivieren. Gespeicherte
          Cookies können in den Systemeinstellungen des Br/owsers gelöscht
        ...
        <p>
          ...
          deren Abschaltung in den Einstellungen des Br/owsers erreicht werden.
        ...
        <p>
          ...
          Jahre gemäß § 257 Abs. 1 Nr. 2 und 3, Abs. 4 HGB (Handelsbr/iefe).
        </p>
        <p>
          ...
          elektronisch erbr/achten Leistungen, Telekommunikations-, Rundfunk-
          und Fernsehleistungen, die an Nichtunternehmer in EU-Mitgliedstaaten
          erbr/acht werden und für die der Mini-One-Stop-Shop (MOSS) in Anspruch
          genommen wird.
        </p>
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Erbr/ingung vertraglicher Leistungen, Service und Kundenpflege,
        ...
        <p>
          ...
          betroffenen Personen gehören unsere Kunden, Interessenten und sonstige
          Geschäftspartner. Die Verarbeitung erfolgt zum Zweck der Erbr/ingung
          von Vertragsleistungen im Rahmen des Betriebs eines Onlineshops,
          Abr/echnung, Auslieferung und der Kundenservices. Hierbei setzen wir
          Session Cookies für die Speicherung des Warenkorb-Inhalts und
        ...
        <p>
          ...
          gegenüber Rechtsberatern und Behörden. Die Daten werden in
        ...
        <p>
          ...
          Nutzer an Schutz vor Missbr/auch und sonstiger unbefugter Nutzung.
          Eine Weitergabe dieser Daten an Dritte erfolgt grundsätzlich nicht,
          außer sie ist zur Verfolgung unserer Ansprüche erforderlich oder es
        ...
        <p>
          ...
          Erbr/ingung von Vertragsleistungen, Abr/echnung und unserem
          Kundenservice. Die Rechtsgrundlagen der Verarbeitung ergeben sich aus
          Art. 6 Abs. 1 lit. b DSGVO (vertragliche Leistungen), Art. 6 Abs. 1
          lit. f DSGVO (Analyse, Statistik, Optimierung, Sicherheitsmaßnahmen).
          Wir verarbeiten Daten, die zur Begründung und Erfüllung der
          vertraglichen Leistungen erforderlich sind und weisen auf die
          Erforderlichkeit ihrer Angabe hin. Eine Offenlegung an Externe erfolgt
          nur, wenn sie im Rahmen eines Auftrags erforderlich ist. Bei der
          ...
          gesetzlichen Vorgaben einer Auftragsverarbeitung gem. Art. 28 DSGVO
          und verarbeiten die Daten zu keinen anderen, als den auftragsgemäßen
          Zwecken.
        </p>
        <p>
          ...
          gem. § 257 Abs. 1 HGB, 10 J, gem. § 147 Abs. 1 AO). Im Fall von Daten,
          die uns gegenüber im Rahmen eines Auftrags durch den Auftraggeber
          offengelegt wurden, löschen wir die Daten entsprechend den Vorgaben
        ...
        <p>
          <span className="ts-muster-content">
            ...
            erbr/ingen. Die hierbei verarbeiteten Daten, die Art, der Umfang und
        ...
        <p>
          ...
          sexuellen Orientierung, ethnischer Herkunft oder religiösen oder
          weltanschaulichen Überzeugunge, verarbeiten. Hierzu holen wir, sofern
          erforderlich, gem. Art. 6 Abs. 1 lit. a., Art. 7, Art. 9 Abs. 2 lit.
          a. DSGVO eine ausdrückliche Einwilligung der Klienten ein und
          verarbeiten die besonderen Kategorien von Daten ansonsten zu Zwecken
          der Gesundheitsvorsorge auf Grundlage des Art. 9 Abs. 2 lit h. DSGVO,
        ...
        <p>
          ...
          Abr/echnungsstellen oder vergleichbare Dienstleister, sofern dies der
          Erbr/ingung unserer Leistungen gem. Art. 6 Abs. 1 lit b. DSGVO dient,
          ...
          notwendig ist. um lebenswichtige Interessen der Klienten oder einer
          anderen natürlichen Person zu schützen oder im Rahmen einer
        ...
        <p>
          ...
          Daten alle drei Jahre überprüft wird; im Übr/igen gelten die
        ...
        <p>
          <span className="ts-muster-content">
            ...
            vertraglichen oder vorvertraglichen Leistungen zu erbr/ingen. Die
        ...
        <p>
          ...
          als auch der Interessen der Nutzer am Schutz vor Missbr/auch und
        ...
        <p>
          ...
          erforderlich sind, wobei die Erforderlichkeit der Aufbewahrung der
          Daten alle drei Jahre überprüft wird; im Übr/igen gelten die
          gesetzlichen Aufbewahrungspflichten.
        </p>
        ...
        <p>
          ...
          ein. Im Übr/igen setzen wir externe&nbsp;Zahlungsdienstleister auf
        ...
        <p>
          ...
          abr/ufbar sind. Wir verweisen auf diese ebenfalls zwecks weiterer
        ...
        <p>
          <span className="ts-muster-content">
            ...
            verarbeiten wir dieselben Daten, die wir im Rahmen der Erbr/ingung
            ...
            Geschäftstätigkeiten, Wahrnehmung unserer Aufgaben und Erbr/ingung
        ...
        <p>
          ...
          Jahren ab Vertragsschluss. Im Übr/igen werden die
        ...
        <h3 id="dsg-organisation">
          Erbr/ingung unserer satzungs- und geschäftsgemäßen Leistungen
        </h3>
        <p>
          <span className="ts-muster-content">
            ...
            Empfänger von Leistungen und Zuwendungen sind. Im Übr/igen
        ...
        <p>
          Wir löschen Daten, die zur Erbr/ingung unserer satzungs- und
          ...
          drei Jahre überprüft; im Übr/igen gelten die gesetzlichen
        ...
        <p>
          ...
          Wir sind berechtigt, sämtliche während der Vertragsdauer gespeicherten
          Daten des Nutzers unwiederbr/inglich zu löschen.
        </p>
        <p>
          Im Rahmen der Inanspruchnahme unserer Registrierungs- und
          Anmeldefunktionen sowie der Nutzung des Nutzerkontos, speichern wird
          ...
          auch der Nutzer an Schutz vor Missbr/auch und sonstiger unbefugter
          Nutzung. Eine Weitergabe dieser Daten an Dritte erfolgt grundsätzlich
          nicht, außer sie ist zur Verfolgung unserer Ansprüche erforderlich
        ...
        <p>
          ...
          Cookis zu verwenden, um Mehrfachabstimmungen zu vermeiden.
        </p>
        <p>
          Die im Rahmen der Kommentare und Beiträge angegebenen Daten, werden
        ...
        <p>
          <span className="ts-muster-content">
            ...
            angeboten wird. Die Nutzung erfolgt auf Grundlage unserer
            berechtigten Interessen im Sinne des Art. 6 Abs. 1 lit. f) DSGVO.
            Mit Hilfe dieses Dienstes werden Kommentare echter Menschen von
            Spam-Kommentaren unterschieden. Dazu werden alle Kommentarangaben an
            einen Server in den USA verschickt, wo sie analysiert und für
            Vergleichszwecke vier Tage lang gespeichert werden. Ist ein
            Kommentar als Spam eingestuft worden, werden die Daten über diese
            Zeit hinaus gespeichert. Zu diesen Angaben gehören der eingegebene
            Name, die Emailadresse, die IP-Adresse, der Kommentarinhalt, der
            Referrer, Angaben zum verwendeten Br/owser sowie dem Computersystem
        ...
        <p>
          ...
          wäre schade, aber leider sehen wir sonst keine Alternativen, die
          ebenso effektiv arbeiten.
        </p>
        <h3 id="dsg-gravatar">Abr/uf von Profilbildern bei Gravatar</h3>
        <p>
          <span className="ts-muster-content">
            Wir setzen innerhalb unseres Onlineangebotes und insbesondere im
            Blog den Dienst Gravatar der Automattic Inc., 60 29th Street #343,
            San Francisco, CA 94110, USA, ein.
          </span>
        </p>
        <p>
        ...
        <p>
          Durch die Anzeige der Bilder br/ingt Gravatar die IP-Adresse der
          Nutzer in Erfahrung, da dies für eine Kommunikation zwischen einem
          Br/owser und einem Onlineservice notwendig ist. Nähere Informationen
          zur Erhebung und Nutzung der Daten durch Gravatar finden sich in den
        ...
        <p>
          ...
          sollten Sie zum Kommentieren eine E-Mail-Adresse nutzen, welche nicht
          bei Gravatar hinterlegt ist. Wir weisen ferner darauf hin, dass es
          auch möglich ist eine anonyme oder gar keine E-Mailadresse zu
          verwenden, falls die Nutzer nicht wünschen, dass die eigene
          E-Mailadresse an Gravatar übersendet wird. Nutzer können die
          Übertragung der Daten komplett verhindern, indem Sie unser
          Kommentarsystem nicht nutzen.
        </p>
        <h3 id="dsg-wordpress-emojis">Abr/uf von Emojis und Smilies</h3>
        <p>
          <span className="ts-muster-content">
            ...
            notwendig, damit die Emojie-Dateien an die Br/owser der Nutzer
            übermittelt werden können. Der Emojie-Service wird von der
            Automattic Inc., 60 29th Street #343, San Francisco, CA 94110, USA,
            angeboten. Datenschutzhinweise von Automattic:{" "}
            <a
              href="https://automattic.com/privacy/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            Content-Delivery-Networks handelt, also Server, die lediglich einer
            schnellen und sicheren Übermittlung der Dateien dienen und die
            personenbezogenen Daten der Nutzer nach der Übermittlung gelöscht
            werden.
          </span>
        </p>
        <p>
        ...
        <p>
          ...
          Einwilligung der Nutzer maßgeblich. Im Übr/igen enthalten unsere
        ...
        <p>
          ...
          statistische Zwecke verwenden. Der Versanddienstleister nutzt die
        ...
        <p>
          <span className="ts-muster-content">
            ...
            dessen Server abgerufen wird. Im Rahmen dieses Abr/ufs werden
            zunächst technische Informationen, wie Informationen zum Br/owser
            und Ihrem System, als auch Ihre IP-Adresse und Zeitpunkt des Abr/ufs
            erhoben.
          </span>
        </p>
        <p>
          ...
          Leseverhaltens anhand derer Abr/uforte (die mit Hilfe der IP-Adresse
          bestimmbar sind) oder der Zugriffszeiten genutzt. Zu den statistischen
          Erhebungen gehört ebenfalls die Feststellung, ob die Newsletter
        ...
        <p>
          ...
          in diesem Fall muss das gesamte Newsletterabonnement gekündigt werden.
        </p>
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Name der abgerufenen Webseite, Datei, Datum und Uhrzeit des Abr/ufs,
            übertragene Datenmenge, Meldung über erfolgreichen Abr/uf,
            Br/owsertyp nebst Version, das Betriebssystem des Nutzers, Referrer
        ...
        <p>
          ...
          Aufklärung von Missbr/auchs- oder Betrugshandlungen) für die Dauer von
        ...
        <p>
          <span className="ts-muster-content">
            ...
            über eine Oberfläche verwalten können (und so z.B. Google Analytics
            sowie andere Google-Marketing-Dienste in unser Onlineangebot
            einbinden). Der Tag Manager selbst (welches die Tags implementiert)
            verarbeitet keine personenbezogenen Daten der Nutzer. Im Hinblick
            auf die Verarbeitung der personenbezogenen Daten der Nutzer wird auf
        ...
        <p>
          ...
          uns gegenüber zu erbr/ingen. Dabei können aus den verarbeiteten Daten
        ...
        <p>
          Die von dem Br/owser des Nutzers übermittelte IP-Adresse wird nicht
          mit anderen Daten von Google zusammengeführt. Die Nutzer können die
          Speicherung der Cookies durch eine entsprechende Einstellung ihrer
          Br/owser-Software verhindern; die Nutzer können darüber hinaus die
          ...
          Link verfügbare Br/owser-Plugin herunterladen und installieren:&nbsp;
          <a
        ...
        <h3 id="dsg-tracking-adsense-personalized">
        ...
        <p>
          ...
          verwendeten Apps und den so erstellten Nutzerprofilen Rückschlüsse auf
          deren Interessen. Werbetreibende nutzen diese Informationen, um ihre
          Kampagnen an diesen Interessen auszurichten, was für Nutzer und
          Werbetreibende gleichermaßen von Vorteil ist. Für Google sind Anzeigen
          dann personalisiert, wenn erfasste oder bekannte Daten die
          Anzeigenauswahl bestimmen oder beeinflussen. Dazu zählen unter anderem
          frühere Suchanfragen, Aktivitäten, Websitebesuche, die Verwendung von
          Apps, demografische und Standortinformationen. Im Einzelnen umfasst
          dies: demografisches Targeting, Targeting auf Interessenkategorien,
          Remarketing sowie Targeting auf Listen zum Kundenabgleich und
          Zielgruppenlisten, die in DoubleClick Bid Manager oder Campaign
        ...
        <h3 id="dsg-tracking-adsense-nonpersonalized">
        ...
        <p>
          ...
          werden die Anzeigen nicht auf Grundlage von Nutzerprofilen angezeigt.
          Nicht personalisierte Anzeigen basieren nicht auf früherem
          Nutzerverhalten. Beim Targeting werden Kontextinformationen
        ...
        <p>
          ...
          dieser Datei wird vermerkt, welche Webseiten der Nutzer aufgesucht,
          für welche Inhalte er sich interessiert und welche Angebote der Nutzer
          geklickt hat, ferner technische Informationen zum Br/owser und
        ...
        <p>
          ...
          Conversion-Statistiken für uns zu erstellen. Wir erfahren jedoch nur
          die anonyme Gesamtanzahl der Nutzer, die auf unsere Anzeige geklickt
        ...
        <p>
          ...
          nicht den Namen oder E-Mailadresse der Nutzer, sondern verarbeitet die
          relevanten Daten cookie-bezogen innerhalb pseudonymer Nutzerprofile.
          D.h. aus der Sicht von Google werden die Anzeigen nicht für eine
        ...
        <p>
          ...
          mutmaßlicher Interessen der Nutzer angezeigt werden. Dies erlaubt uns
          Anzeigen für und innerhalb unseres Onlineangebotes gezielter
          anzuzeigen, um Nutzern nur Anzeigen zu präsentieren, die potentiell
          deren Interessen entsprechen. Falls einem Nutzer z.B. Anzeigen für
          Produkte angezeigt werden, für die er sich auf anderen Onlineangeboten
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Interesse an der Analyse, Optimierung und wirtschaftlichem Betrieb
            unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO)
            das Plugin Jetpack (hier die Unterfunktion „Wordpress Stats“),
            welches ein Tool zur statistischen Auswertung der Besucherzugriffe
            einbindet und von Automattic Inc., 60 29th Street #343, San
            Francisco, CA 94110, USA. Jetpack verwendet sog. „Cookies“,
        ...
        <p>
          ...
          dieses Onlineangebotes werden auf einem Server in den USA gespeichert.
          Dabei können aus den verarbeiteten Daten Nutzungsprofile der Nutzer
          erstellt werden, wobei diese nur zu Analyse- und nicht zu Werbezwecken
          eingesetzt werden. Weitere Informationen erhalten Sie in den
          Datenschutzerklärungen von Automattic:{" "}
          <a
            href="https://automattic.com/privacy/"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Sinne des Art. 6 Abs. 1 lit. f. DSGVO) die folgenden Daten
            verarbeitet: der von Ihnen verwendete Br/owsertyp und die
            Br/owserversion, das von Ihnen verwendete Betriebssystem, Ihr
        ...
        <p>
          Matomo verwendet Cookies, die auf dem Computer der Nutzer gespeichert
          werden und die eine Analyse der Benutzung unseres Onlineangebotes
          durch die Nutzer ermöglichen. Dabei können aus den verarbeiteten Daten
          pseudonyme Nutzungsprofile der Nutzer erstellt werden. Die Cookies
          haben eine Speicherdauer von einer Woche. Die durch das Cookie
          erzeugten Informationen über Ihre Benutzung dieser Webseite werden nur
        ...
        <p>
          ...
          Matomo jederzeit mit Wirkung für die Zukunft widersprechen, indem sie
          auf den untenstehenden Link klicken. In diesem Fall wird in ihrem
          Br/owser ein sog. Opt-Out-Cookie abgelegt, was zur Folge hat, dass
          Matomo keinerlei Sitzungsdaten mehr erhebt. Wenn Nutzer ihre Cookies
          löschen, so hat dies jedoch zur Folge, dass auch das Opt-Out-Cookie
          gelöscht wird und daher von den Nutzern erneut aktiviert werden muss.
        </p>
        <p>
        ...
        <p>
          [Bitte setzen Sie an dieser Stelle das IFRAME von Matomo mit dem
          opt-out cookie ein (und schalten die IP-Anonymisierung im
          Einstellungsbereich ein)].
        </p>
        <h3 id="dsg-facebook-pixel">
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Facebook Inc., 1 Hacker Way, Menlo Park, CA 94025, USA, bzw. falls
        ...
        <p>
          ...
          Marktforschungszwecke nachvollziehen, in dem wir sehen ob Nutzer
        ...
        <h3 id="dsg-tracking-etracker">etracker</h3>
        <p>
          <span className="ts-muster-content">
            Wir setzen auf Grundlage unserer berechtigten Interessen (d.h.
            Interesse an der Analyse, Optimierung und wirtschaftlichem Betrieb
            unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO)
            den Analysedienst „etracker“ der etracker GmbH, Erste Br/unnenstraße
            1 20459 Hamburg, ein.
          </span>
        </p>
        <p>
          Die erhobenen Daten werden dabei ausschließlich pseudonym analysiert,
          allein auf Servern in Deutschland gespeichert, nicht mit anderen Daten
          zusammengeführt oder an Dritte weitergegeben.
        </p>
        <p>
          Bei der Speicherung der Nutzerdaten werden insbesondere auch die
          IP-Adressen, Geräte- und Domaindaten der Nutzer nur verkürzt
          gespeichert beziehungsweise verschlüsselt, so dass ein Rückschluss auf
          den einzelnen Nutzer nicht möglich ist. Die Kürzung der IP-Adresse
          erfolgt zum frühestmöglichen Zeitpunkt und zwar standardmäßig
          automatisiert. Aus den durch etracker verarbeiteten Daten werden unter
          Einsatz von Cookies pseudonyme Nutzungsprofile der Nutzer erstellt.
          Identifier zur Wiedererkennung eines App-Nutzers, Durchführung von
          Session- und Cross-Device-Tracking sowie Bereitstellung von
          verhaltensbezogenen Daten für Remarketing werden jedoch sicher
          pseudonymisiert bzw. verschlüsselt. Ferner sichert etracker den Schutz
          der verarbeiteten Daten der Nutzer vertraglich durch den Abschluss
          eines Auftragsverarbeitungsvertrages gem. Art. 28 Abs. 3 S. 1 DSGVO
          zu.
        </p>
        <p>
          Der Datenerhebung und -speicherung können Sie jederzeit mit Wirkung
          für die Zukunft widersprechen. Um einer Datenerhebung und -speicherung
          ...
          bewirkt, dass zukünftig keine Besucherdaten Ihres Br/owsers bei
          etracker erhoben und gespeichert werden:{" "}
          <a
            href="http://www.etracker.de/privacy?et=[BITTE-EINSETZEN-IHRE-Account-ID]"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <p>
          Durch das Opt-Out wird ein Opt-Out-Cookie mit dem Namen “cntcookie”
          von etracker gesetzt. Bitte löschen dieses Cookie nicht, solange Sie
          Ihren Widerspruch aufrechterhalten möchten.
        </p>
        <p>
        ...
        <p>
          ...
          technische Informationen zum Br/owser und Betriebssystem, verweisende
        ...
        <p>
          <span className="ts-muster-content">
            ...
            und verweisen hierzu auf die Datenschutzerklärung (
            <a
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Begriffen “Like”, “Gefällt mir” oder einem „Daumen hoch“-Zeichen)
            oder sind mit dem Zusatz “Facebook Social Plugin” gekennzeichnet.
            Die Liste und das Aussehen der Facebook Social Plugins kann hier
            eingesehen werden:&nbsp;
            <a
        ...
        <p>
          ...
          Facebook seine IP-Adresse in Erfahrung br/ingt und speichert. Laut
        ...
        <p>
          <span className="ts-muster-content">
            Innerhalb unseres Onlineangebotes können Funktionen und Inhalte des
            Dienstes LinkedIn, angeboten durch die inkedIn Ireland Unlimited
        ...
        <p>
          <span className="ts-muster-content">
            ...
            Schaltflächen gehören, mit denen Nutzer Inhalte dieses
            Onlineangebotes innerhalb von Twitter teilen können. Sofern die
